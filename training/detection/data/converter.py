...
from detection.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
from detection.utils.downloads import download, zip_directory
    ...
    Notes:
        The input directory structure assumed for dataset:
            ...
            - labels
                ...
                └─ NNN.txt
    """
    from detection import SAM
    from detection.data import YOLODataset
    from detection.utils.ops import xywh2xyxy
...
def convert_to_multispectral(path, n_channels=10, replace=False, zip=False):
    ...
    from detection.data.utils import IMG_FORMATS
