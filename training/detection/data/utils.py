...
from detection.utils.checks import check_file, check_font, is_ascii
from detection.utils.downloads import download, safe_download, unzip_file
from detection.utils.ops import segments2boxes
...
def visualize_image_annotations(image_path, txt_path, label_map):
    ...
    from detection.utils.plotting import colors
...
def check_cls_dataset(dataset, split=""):
    ...
    if not train_set.is_dir():
        ...
        if image_files:
            from detection.data.split import split_classify_dataset
...
class HUBDatasetStats:
    ...
    def process_images(self):
        ...
        from detection.data import YOLODataset  # ClassificationDataset
