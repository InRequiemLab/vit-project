...
from detection.cfg import TASK2DATA, get_cfg
from detection.data import build_dataloader
from detection.data.dataset import YOLODataset
from detection.data.utils import check_cls_dataset, check_det_dataset
from detection.nn.autobackend import check_class_names, default_class_names
from detection.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from detection.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
...
from detection.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from detection.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from detection.utils.export import export_engine, export_onnx
from detection.utils.files import file_size, spaces_in_path
from detection.utils.ops import Profile, nms_rotated
from detection.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from detection.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from detection.utils.tal import make_anchors
