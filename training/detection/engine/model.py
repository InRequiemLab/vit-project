...
from detection.cfg import TASK2DATA, get_cfg, get_save_dir
from detection.engine.results import Results
from detection.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.is_hub_model(model):
            from detection.hub import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        from detection.hub import HUB_WEB_ROOT
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from detection.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs: Any,
        ...
        """
        self._check_is_pytorch_model()
        from detection.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from detection.utils.tuner import run_ray_tune
