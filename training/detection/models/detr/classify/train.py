...
from detection.data import ClassificationDataset, build_dataloader
from detection.engine.trainer import BaseTrainer
from detection.models import detr
from detection.nn.tasks import ClassificationModel
from detection.utils import DEFAULT_CFG, LOGGER, RANK
from detection.utils.plotting import plot_images, plot_results
from detection.utils.torch_utils import is_parallel, strip_optimizer, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    def get_validator(self):
        ...
        return detr.classify.ClassificationValidator(
