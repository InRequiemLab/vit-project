...
from detection.nn.tasks import SegmentationModel
from detection.utils import DEFAULT_CFG, RANK
from detection.utils.plotting import plot_images, plot_results


class SegmentationTrainer(detr.detect.DetectionTrainer):
    """
    ...
    def get_validator(self):
        ...
        return detr.segment.SegmentationValidator(
