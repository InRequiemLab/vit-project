...
from detection.data import build_yolo_dataset
from detection.models import detr
from detection.nn.tasks import WorldModel
from detection.utils import DEFAULT_CFG, RANK, checks
...
class WorldTrainer(detr.detect.DetectionTrainer):
    """
