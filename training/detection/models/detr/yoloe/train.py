...
from detection.data import YOLOConcatDataset, build_yolo_dataset
from detection.data.augment import LoadVisualPrompt
from detection.models.detr.detect import DetectionTrainer, DetectionValidator
from detection.nn.tasks import YOLOEModel
from detection.utils import DEFAULT_CFG, LOGGER, RANK
from detection.utils.torch_utils import de_parallel
