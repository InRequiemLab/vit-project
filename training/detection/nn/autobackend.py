...
from detection.utils import ARM64, IS_JETSON, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from detection.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from detection.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from detection.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from detection.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from detection.utils.triton import TritonRemoteModel
