...
from detection.nn.autobackend import check_class_names
from detection.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from detection.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from detection.utils.checks import check_requirements, check_suffix, check_yaml
from detection.utils.loss import (
    E2EDetectLoss,
...
from detection.utils.ops import make_divisible
from detection.utils.plotting import feature_visualization
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from detection.models.utils.loss import RTDETRDetectionLoss
...
class YOLOEModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=False, without_reprta=False):
        ...
        """
        from detection.nn.text_model import build_text_model
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from detection.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from detection.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    """
    from detection.utils.downloads import attempt_download_asset
