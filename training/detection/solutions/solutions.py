...
from detection.solutions.config import SolutionConfig
from detection.utils import ASSETS_URL, LOGGER
from detection.utils.checks import check_imshow, check_requirements
from detection.utils.plotting import Annotator
