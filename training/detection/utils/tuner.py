...
from detection.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from detection.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
